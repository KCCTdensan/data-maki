...
import type { MaxLength, MinItems, MinLength } from "typia/lib/tags";
...
export interface Board {
  ...
  start: Array<string & tags.MinLength<1> & tags.MaxLength<256>> & MinItems<1> & tags.MaxItems<256>;
  readonly goal: Array<string & tags.MinLength<1> & tags.MaxLength<256>> & MinItems<1> & tags.MaxItems<256>;
}
